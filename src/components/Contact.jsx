...
function Contact() {
  return (
    <div className='py-[5rem] px-3 flex flex-col justify-center my-auto items-center'>
        <h1 className='text-[#E1EEDD] font-bold text-3xl md:text-4xl mt-3'>Booking form</h1>
