    ...
    <div className='pt-[5rem] max-w-[1690px] m-auto'>
         ...
         <div className='p-2 flex flex-col justify-center items-center  md:flex-row w-full overflow-hidden'>
            ...
            <p className='p-2 text-xl md:text-2xl m-2'>
                Arima Hire offers reliable and professional airport transfer services for individuals, families, and groups. Our private hire taxi is equipped with comfortable seating and ample space for luggage, ensuring a comfortable journey to and from the airport. Our experienced driver is knowledgeable about the best routes and traffic patterns, allowing you to arrive at your destination on time and in style. With competitive pricing and flexible scheduling options, Arima Hire is your go-to choice for airport transfers.
                <Link to='/services'>
